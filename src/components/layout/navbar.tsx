...
//               <div className="text-blue-300 text-xs font-sans tracking-widest">9</div>
//             </div>
//           </Link>
...
//                   pathname === link.href ? 'text-blue-300 bg-white/10' : 'text-white/80 hover:text-white hover:bg-white/10'
//                 )}
//               >
...
'fixed top-0 left-0 right-0 z-50 transition-all duration-300',
scrolled
? 'bg-white/60 backdrop-blur-xl border-b border-black/5 shadow-md'
: 'bg-white/30 backdrop-blur-md'
)}
> <div className="container mx-auto px-4 sm:px-6 lg:px-8"> <nav className="flex items-center justify-between h-16">
...
```
      ...
      <div className="hidden lg:flex items-center gap-3">
        <Link
          href="/contact"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-black text-white font-semibold text-sm hover:bg-black/90 transition"
        >
          Book a Call
    ...
    {/* Mobile Menu */}
    {isOpen && (
      <div className="lg:hidden bg-white/70 backdrop-blur-xl border border-black/10 py-4 px-3 space-y-1 rounded-2xl shadow-xl mt-2">
        ...
        <div className="pt-3 border-t border-black/10 mt-2">
          <Link
            href="/contact"
            onClick={() => setIsOpen(false)}
            className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-lg bg-black text-white font-semibold text-sm hover:bg-black/90"
          >
            Book a Consultation
          </Link>
        </div>
