...
import { ArrowRight, CheckCircle2, Mic, GraduationCap, Star, ChevronRight } from 'lucide-react'
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen bg-brand-gradient flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-24 pb-20">
          <div className="max-w-4xl">
            ...
            <p className="text-white/80 text-xl leading-relaxed mb-10 max-w-2xl animate-slide-up-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-slide-up-3">
              <Link href="/services"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-white text-blue-800 font-semibold text-base shadow-xl hover:bg-blue-50 transition-colors"
              >
                Enquire Now <ArrowRight className="h-5 w-5" />
              </Link>
              <Link href="/podcast"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/30 text-white font-medium text-base hover:bg-white/10 transition-colors"
              >
                <Mic className="h-5 w-5 text-white/80" /> Listen to Podcast
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="section-pad bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="heading-xl mb-4">We Help You In</h2>
            ...
            {pillars.map((p) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <h3 className="heading-md mb-3 group-hover:text-blue-600 transition-colors">{p.title}</h3>
      ...
      <section className="section-pad bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <Link href="/about" className="inline-flex items-center gap-2 mt-8 text-blue-600 font-semibold hover:text-blue-700 transition-colors">
      ...
      <section className="py-24 bg-brand-gradient relative overflow-hidden">
        <div className="absolute inset-0 bg-hero-pattern opacity-100" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 rounded-full bg-blue-300/20 blur-3xl" />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-white text-blue-800 font-semibold shadow-xl hover:bg-blue-50 transition-colors"
            >
              Book a Call <ArrowRight className="h-5 w-5" />
            </Link>
            <Link href="/services"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/30 text-white font-medium hover:bg-white/10 transition-colors"
            >
              Browse Services
            </Link>
          </div>
